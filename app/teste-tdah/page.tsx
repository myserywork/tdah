          ...
          <motion.div key="result" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950">
            ...
            <footer className="py-8 px-4 border-t border-slate-200 dark:border-slate-800">
              <div className="max-w-3xl mx-auto text-center">
                <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">* Este teste e material não substituem diagnóstico ou tratamento médico profissional</p>
                <Link href="/" className="text-sm text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">← Voltar ao início</Link>
              </div>
            </footer>
          </motion.div>
        )}
